        ...
        <List relaxed>
            {data && data.map(message => (
                <List.Item key={message.id}>
                    <Segment padded
                             floated={getAlignment(username, message.username)} inverted
                             color={getColor(username, message.username)}
                             style={{textAlign: getAlignment(username, message.username)}}>
                        <p>
                            ...
                            <span style={{
                                fontSize: "mini",
                                color: "grey"
                            }}>{formatDate(new Date(message.timestamp))}</span>
                        </p>
                    </Segment>
                </List.Item>
            ))}
